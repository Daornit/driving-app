          ...
          <CardBody>
            <GridContainer>
                <GridItem xs={12} sm={12} md={4}>
                    <Card>
                        <CardHeader>
                    <h4>Зохицуулагчийн дохиогоор уулзварт нэврэх</h4>
                    
                    </CardHeader>
                    <CardBody>
    
            <GridItem xs={12} sm={12} md={12}>
            <iframe src="https://www.youtube.com/embed/XiKdXa_Fpmk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </GridItem>
            <Box><p>
                Зохицуулагч нь дохиурыг өргөсөн тохиолдолд бүх чигийн автомашинуудын хөдлөх чиглэл зогсоно.
                </p></Box>
                    </CardBody>
                    </Card>
                </GridItem>
